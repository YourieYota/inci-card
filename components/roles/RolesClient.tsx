...
export default function RolesClient({ currentUserSlug }: { currentUserSlug: string }) {
  ...
  const fetchRoles = useCallback(async () => {
    ...
    try {
      ...
      setRoles(data.map(r => ({ ...r, createdAt: new Date(r.createdAt) })));
    } catch (e: any) {
                ...
                <div className="p-5 flex flex-col gap-4 flex-1">
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex gap-1 shrink-0">
                      <button
                        onClick={() => { setEditingRole(role); setMode('edit'); }}
                      ...
                      {!role.isSystem && (
                        <button
                          ...
                          className="p-1.5 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-lg transition"
                          title="Supprimer">
